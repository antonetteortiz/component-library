...
import CartHeartFilled from "./blueButtons.svg";
import CartHeart from "./whiteButtons.svg";
import GroupedIcon from "./productDescription.svg";
import Macbook from "./smallMacbook.svg";
import Price from "./fivehundred.svg";
import Stars from "./rate.svg";
import Beats from "./beats.png";
import Test from "./hotMacbook.svg";
import Reviews from "./reviews.svg";
import Submit from "./submitReview.svg";
import Cart from "./addCart.svg";
import heart from "./fivehundred.svg";
    ...
    if (this.props.row) {
      return (
        <div
          ...
          onMouseEnter={this.havebackgroundColor}
